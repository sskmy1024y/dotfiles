# Generated by Powerlevel10k configuration wizard on 2022-06-04 at 13:00 JST.
...
() {
  ...
  # Context background color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_FOREGROUND=41
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_SUDO_BACKGROUND=009
